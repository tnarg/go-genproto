...
func (m *SyncRecognizeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *SyncRecognizeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AsyncRecognizeRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AsyncRecognizeRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RecognitionConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SampleRate != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintCloudSpeech(dAtA, i, uint64(m.SampleRate))
	}
	...
	if m.SpeechContext != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintCloudSpeech(dAtA, i, uint64(m.SpeechContext.Size()))
		n8, err := m.SpeechContext.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
func (m *SyncRecognizeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SyncRecognizeResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AsyncRecognizeResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AsyncRecognizeResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *AsyncRecognizeMetadata) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *AsyncRecognizeMetadata) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *StreamingRecognizeResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResultIndex != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintCloudSpeech(dAtA, i, uint64(m.ResultIndex))
	}
	if m.EndpointerType != 0 {
		dAtA[i] = 0x20
		i++
		i = encodeVarintCloudSpeech(dAtA, i, uint64(m.EndpointerType))
	}
	return i, nil
}
...
func (m *SyncRecognizeRequest) Size() (n int) {
	var l int
	_ = l
	if m.Config != nil {
		l = m.Config.Size()
...
func (m *AsyncRecognizeRequest) Size() (n int) {
	var l int
	_ = l
	if m.Config != nil {
		l = m.Config.Size()
...
func (m *RecognitionConfig) Size() (n int) {
	...
	if m.SampleRate != 0 {
		n += 1 + sovCloudSpeech(uint64(m.SampleRate))
	}
...
func (m *SyncRecognizeResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Results) > 0 {
...
func (m *AsyncRecognizeResponse) Size() (n int) {
	var l int
	_ = l
	if len(m.Results) > 0 {
		for _, e := range m.Results {
...
func (m *AsyncRecognizeMetadata) Size() (n int) {
	var l int
	_ = l
	if m.ProgressPercent != 0 {
...
func (m *StreamingRecognizeResponse) Size() (n int) {
	...
	if m.ResultIndex != 0 {
		n += 1 + sovCloudSpeech(uint64(m.ResultIndex))
	}
	if m.EndpointerType != 0 {
		n += 1 + sovCloudSpeech(uint64(m.EndpointerType))
	}
	return n
}
...
func (m *SyncRecognizeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: SyncRecognizeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SyncRecognizeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AsyncRecognizeRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AsyncRecognizeRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AsyncRecognizeRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *RecognitionConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpeechContext", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SpeechContext == nil {
				m.SpeechContext = &SpeechContext{}
			}
			if err := m.SpeechContext.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SyncRecognizeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SyncRecognizeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SyncRecognizeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
...
func (m *AsyncRecognizeResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AsyncRecognizeResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AsyncRecognizeResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 2:
			if wireType != 2 {
...
func (m *AsyncRecognizeMetadata) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AsyncRecognizeMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AsyncRecognizeMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *StreamingRecognizeResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResultIndex", wireType)
			}
			m.ResultIndex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ResultIndex |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndpointerType", wireType)
			}
			m.EndpointerType = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.EndpointerType |= (StreamingRecognizeResponse_EndpointerType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorCloudSpeech = []byte{
	...
	,
}
