...
func (m *Color) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Red != 0 {
		dAtA[i] = 0xd
		i++
		i = encodeFixed32Color(dAtA, i, uint32(math.Float32bits(float32(m.Red))))
	}
	if m.Green != 0 {
		dAtA[i] = 0x15
		i++
		i = encodeFixed32Color(dAtA, i, uint32(math.Float32bits(float32(m.Green))))
	}
	if m.Blue != 0 {
		dAtA[i] = 0x1d
		i++
		i = encodeFixed32Color(dAtA, i, uint32(math.Float32bits(float32(m.Blue))))
	}
	if m.Alpha != nil {
		dAtA[i] = 0x22
		i++
...
var fileDescriptorColor = []byte{
	...
	0x29, 0x4d, 0x0d, 0x82, 0xa8, 0x74, 0xca, 0x3c, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6,
	0x07, 0x8f, 0xe4, 0x18, 0xb9, 0xf8, 0x93, 0xf3, 0x73, 0xf5, 0x90, 0x9c, 0xed, 0xc4, 0x05, 0x76,
	0x54, 0x00, 0x48, 0x7f, 0x00, 0x63, 0x94, 0x19, 0x54, 0x2a, 0x3d, 0x3f, 0x27, 0x31, 0x2f, 0x5d,
	0x2f, 0xbf, 0x28, 0x5d, 0x3f, 0x3d, 0x35, 0x0f, 0x6c, 0xba, 0x3e, 0x44, 0x2a, 0xb1, 0x20, 0xb3,
	0x18, 0x29, 0x24, 0xac, 0xc1, 0xe4, 0x22, 0x26, 0x66, 0xf7, 0x90, 0x80, 0x24, 0x36, 0xb0, 0x42,
	0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xe0, 0xc5, 0x62, 0xa3, 0x31, 0x01, 0x00, 0x00,
}
